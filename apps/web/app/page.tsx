  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link href="/new" className="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700">
          + New Job
        </Link>
      </div>
      {jobs.length === 0 ? (
        <div className="rounded-xl border border-dashed border-slate-300 bg-white p-16 text-center text-slate-500">
          No jobs yet. Drop the shipment documents into a <Link className="text-indigo-600 underline" href="/new">new job</Link> to
